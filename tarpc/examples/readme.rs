...
async fn main() -> io::Result<()> {
    // tarpc_tcp_transport is provided by the associated crate tcp-transport. It makes it
    // easy to start up a Serde-powered serialization strategy over TCP.
    let mut transport =
        tarpc_tcp_transport::listen("0.0.0.0:0", (Json::default, Json::default)).await?;
