...
async fn main() -> io::Result<()> {
    ...
    let add_listener = tarpc_tcp_transport::listen("0.0.0.0:0", (Json::default, Json::default))
        .await?
    ...
    let double_listener = tarpc_tcp_transport::listen("0.0.0.0:0", (Json::default, Json::default))
        .await?
        .filter_map(|r| future::ready(r.ok()));
